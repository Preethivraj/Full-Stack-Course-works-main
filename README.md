...
[![Author](https://img.shields.io/badge/Author-Preethivraj-brightgreen?style=for-the-badge&logo=github)](https://github.com/shinchan2222)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Preethivraj/Full-Stack-Coursework.git
   ```

2. **Navigate into the project directory:**
   ```bash
   cd Full-Stack-Course-works-main
   ```
...
- **Developer:** [Preethivraj.M](https://github.com/Preethivraj)
